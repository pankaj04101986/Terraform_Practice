pipeline {
    ...
    parameters {
            booleanParam(name: 'INIT_TERRAFORM', defaultValue: false, description: 'Check to initialize Terraform changes')
    ...
    stages {
        stage('Clone Repository') {
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/pankaj04101986/Terraform_Practice.git'
